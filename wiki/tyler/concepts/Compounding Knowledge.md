...
The central insight behind the [[concepts/LLM Wiki Pattern]]: knowledge in a wiki compounds like interest in a bank. Every source added, every question answered, every analysis filed makes the wiki more valuable — not just by adding pages, but by enriching the connections between existing pages.
...
See [[concepts/LLM Wiki Pattern]] for the full architecture.
See [[concepts/Hot Cache]] for the session context mechanism.
See [[entities/Andrej Karpathy]] for the origin of this framing.
See [[comparisons/Wiki vs RAG]] for a detailed comparison with the RAG approach.
